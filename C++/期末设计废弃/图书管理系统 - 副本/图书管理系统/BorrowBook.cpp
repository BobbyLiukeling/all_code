...
//借书模块
void BorrowBook::borrow(int KEY)
{
	//1、输入用户信息
	...
	case 1:
	{
		...
		string filename = "Teacher_Reader.txt";
	...
	case 2:
	{
		...
		string filename = "Student_reader.txt";
	...
	case 3:
	{
		...
		string filename = "Outside_campus_Reader.txt";
...
//还书
void BorrowBook::returnBook(int KEY)
{
	//1、读取读者信息（不显示）
	//2、匹配用户名或ID
	//3、显示借书信息
