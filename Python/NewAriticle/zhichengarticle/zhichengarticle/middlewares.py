...
class ZhichengarticleDownloaderMiddleware(object):
    ...
    def process_response(self, request, response, spider):
        ...
        try:
            if (spider.name == "ariticle") and str(request.url).startswith('https://www.zhihu.com/search?type=content&q=')==False:
            ...
            elif spider.name == "article" and str(request.url).startswith('https://www.zhihu.com/search?type=content&q='):
                self.web.get(request.url)
                time.sleep(1.5)
