    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_sn', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='交易编号')),
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancal', '取消'), ('cancal', '待支付')], max_length=10, verbose_name='订单状态')),
