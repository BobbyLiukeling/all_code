...
relativeLinkTestsForRFC3986 = [
    ...
    ('/static/g', 'http://a/b/g'),
    ('/static/..', 'http://a/'),
    ('/static//static/', 'http://a/'),
    ('/static//static/g', 'http://a/g'),

    # Abnormal examples
    # ".." cannot be used to change the authority component of a URI.
    ('/static//static//static/g', 'http://a/g'),
    ('/static//static//static//static/g', 'http://a/g'),
    ...
    ('./g/.', 'http://a/b/c/g/'),
    ('g/./h', 'http://a/b/c/g/h'),
    ('g//static/h', 'http://a/b/c/h'),
    ('g;x=1/./y', 'http://a/b/c/g;x=1/y'),
    ('g;x=1//static/y', 'http://a/b/c/y'),
    # Separating the reference's query and fragment components from the path.
    ('g?y/./x', 'http://a/b/c/g?y/./x'),
    ('g?y//static/x', 'http://a/b/c/g?y//static/x'),
    ('g#s/./x', 'http://a/b/c/g#s/./x'),
    ('g#s//static/x', 'http://a/b/c/g#s//static/x')
]
...
class TestURL(HyperlinkTestCase):
    ...
    def test_click(self):
        ...
        u = URL.from_text('http://hatnote.com/a/b//static/c/./d/e/..')
    ...
    def test_clickCollapse(self):
        ...
        tests = [
            ...
            ['http://localhost/a/b/c', '/static/d/e', 'http://localhost/a/d/e'],
            ['http://localhost/a/b/c', '/./d/e', 'http://localhost/d/e'],
            ['http://localhost/a/b/c', '//static/d/e', 'http://localhost/d/e'],
            ['http://localhost/a/b/c/', '/static//static/d/e/',
             'http://localhost/a/d/e/'],
            ['http://localhost/a/./c', '/static/d/e', 'http://localhost/d/e'],
            ['http://localhost/a/./c/', '/static/d/e', 'http://localhost/a/d/e'],
            ['http://localhost/a/b/c/d', './e//static/f//static/g',
    ...
    def test_normalize(self):
        url = URL.from_text('HTTP://Example.com/A%61/.//static/A%61?B%62=C%63#D%64')
        assert url.get('Bb') == []
