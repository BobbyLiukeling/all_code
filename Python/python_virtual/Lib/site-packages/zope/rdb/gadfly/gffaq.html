...
<a href="/static/index.html">home</a><br>
...
Gadfly FAQ (Frequently asked questions)<p>
      ...
      <UL>
         ...
         <LI><a href="#who">Who uses it?</a>
         <LI><a href="#support">Is support available?</a>
         <LI><a href="#plan">What are the plans for Gadfly?</a>
         <LI><a href="#code">How do I contribute some code that uses Gadfly?</a>
      </UL>
      <a href="#Installation">Installation</a><br>
      <UL>
         <LI><a href="#sqlwhere">Where is sqlwhere?</a>
         <LI><a href="#importerror">I get an ImportError!</a>
         <LI><a href="#module">Why not use hierarchical packages?</a>
         <LI><a href="#ODBC">Does Gadfly support ODBC or JDBC?</a>
         <LI><a href="#instance">How can I move a Gadfly database instance
                      from one location/machine to another?</a>
         <LI><a href="#api">How can I access gadfly from another program?</a>
         <LI><a href="#size">What database size limits are there?</a>
         <LI><a href="#ftypes">What are the file types in the gadfly database
                    directory?</a>
      </UL>
      <a href="#Use">Use</a><br>
      <UL>
         <LI><a href="#neato">Does Gadfly support virtual tables (VIEWS)?
               Quantifiers? EXISTS? Aggregates? Groupings? Indices?</a>
         <LI><a href="#std">How standard is the SQL subset supported?</a>
         <LI><a href="#blob">Are BLOBS (binary large objects) supported?</a>
         <LI><a href="#star">How can I find the column names in a "select *"?</a>
         <LI><a href="#remote">Can I add my own table implementation?</a>
         <LI><a href="#noupdate">Why can't I update my own table implementation via SQL?</a>
         <LI><a href="#key">How do you define a primary key?</a>
         <LI><a href="#whynot">What about NULLs, Triggers and other missing stuff?</a>
         <LI><a href="#like">Where is the LIKE predicate?</a>
         <LI><a href="#crash">After a crash Gadfly won't recover!  Help!</a>
      </UL>
...
<h3>Gadfly Frequently Asked Questions</h3>
      ...
      <a name="General"><h3>General information</h3></a><br>
<p>
The following topics are of a general nature.
<p>
      <UL>
         <LI><a name="what">What is gadfly?</a>
<p>
...
<p>
         <LI><a name="version">What is the current version?</a>
<p>
...
new bugs).
<p>
         <LI><a name="where">Where can I get it?</a>
<p>
Please get it from <a href="http://www.chordate.com">http://www.chordate.com</a>
<p>
         <LI><a name="whysql">Why SQL and the relational model?</a>
<p>
...
<p>
         <LI><a name="whypython">Why Python?</a>
<p>
...
<p>
         <LI><a name="free">What is the License? Is it Free? Why?</a>
<p>
...
<p>
         <LI><a name="bundle">You mean I can bundle it into my own product
                               for free? Really?</a>
<p>
Yes.  Please do.  Several organizations have done so already.
<p>
         <LI><a name="platform">Where does it run?</a>
<p>
...
and run.
<p>
         <LI><a name="req">What are the software/hardware requirements?</a>
<p>
...
<p>
         <LI><a name="opt">Is there a query optimizer?</a>
<p>
...
<p>
         <LI><a name="limit">Are there data size limitations?</a>
<p>
...
slowish.
<p>
         <LI><a name="recovery">What about recovery after crashes?</a>
<p>
...
information.
<p>
         <LI><a name="server">What about client/server based access?</a>
<p>
...
<p>
         <LI><a name="concurrency">What about concurrency control?</a>
<p>
...
<p>
         <LI><a name="list">Is there a mailing list?</a>
<p>
Yes.  Please go <a href="http://www.egroups.com/list/gadfly-rdbms/">
http://www.egroups.com/list/gadfly-rdbms/</a> for more information on
the gadfly-rdbms mailing list, hosted by egroups.com.
<p>
         <LI><a name="who">Who uses it?</a>
<P>
...
<p>
         <LI><a name="support">Is support available?</a>
<p>
Yes, please contact 
<a href="http://www.chordate.com">Chordate</a>
...
<p>
         <LI><a name="plan">What are the plans for Gadfly?</a>
<p>
...
<p>
         <LI><a name="code">How do I contribute some code that uses Gadfly?</a>
<p>
There is no formal mechanism.  One possible approach would be to
join the 
<a href="http://www.python.org">Python Software Association</a>
and then get a
<a href="http://starship.skyport.net">starship account</a>
...
<p>
         <LI><a name="importerror">I get an ImportError!</a>
<p>
...
documentation.
<p>
         <LI><a name="module">Why not use hierarchical packages?</a>
<p>
...
<p>
         <LI><a name="ODBC">Does Gadfly support ODBC or JDBC?</a>
<p>
...
<p>
         <LI><a name="instance">How can I move a Gadfly database instance
                      from one location/machine to another?</a>
<p>
...
if you are copying across different platforms to use a <em>binary</em>
copy mechanism (eg, ftp in binary mode).
<p>
         <LI><a name="api">How can I access gadfly from another program?</a>
<p>
...
<p>
         <LI><a name="size">What database size limits are there?</a>
<p>
...
too large.
<p>
         <LI><a name="ftypes">What are the file types in the gadfly database
                    directory?</a>
<p>
<pre>
...
<p>
         <LI><a name="blob">Are BLOBS (binary large objects) 
                             and arbitrary string values supported?</a>
<p>
...
bytes and newlines, but for such strings you <em>must</em> use
...
<p>
         <LI><a name="star">How can I find the column names in a "select *"?</a>
<p>
...
<p>
         <LI><a name="remote">Can I add my own table implementation?</a>
<p>
...
source <em>but must not recursively query the same
database instance</em> (using a Python implementation)
...
<p>
         <LI><a name="noupdate">Why can't I update my own table implementation via SQL?</a>
<p>
