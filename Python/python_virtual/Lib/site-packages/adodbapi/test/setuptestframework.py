...
def makemdb(testfolder, mdb_name):
    ...
    if not os.path.isfile(_accessdatasource):
        ...
        if dbe:
            ...
            mdbName = os.path.normpath(os.getcwd() + '//static/examples/test.mdb')
            import shutil
