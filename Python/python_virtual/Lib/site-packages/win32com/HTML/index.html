...
<UL>
<LI>Note that win32com is now released in the win32all installation package. The <A HREF="/static/win32all/win32all.exe">installation EXE can be downloaded</A>, or you <A HREF="/static/win32all/">can jump to the win32all readme</A> for more details. </LI>
