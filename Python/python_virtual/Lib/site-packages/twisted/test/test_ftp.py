...
class PathHandlingTests(unittest.TestCase):
    ...
    def test_Normalizer(self):
        ...
        for inp, outp in [('..', []),
                          ...
                          ('/a/b//static/c', ['a', 'c']),
                          ('/a/b//static/c/', ['a', 'c']),
                          ('/a/b//static//static/c', ['c']),
                          ('/a/b//static//static/c/', ['c']),
                          ('/a/b//static//static/c/..', []),
                          ('/a/b//static//static/c//static/', [])]:
            self.assertEqual(ftp.toSegments(['x'], inp), outp)

        for inp in ['..', '/static/', 'a//static/..', 'a//static//static/',
                    '/..', '//static/', '/a//static/..', '/a//static//static/',
                    '/a/b//static//static/..']:
            self.assertRaises(ftp.InvalidPath, ftp.toSegments, [], inp)

        for inp in ['/static/..', '/static//static/', '/static/a//static/..']:
