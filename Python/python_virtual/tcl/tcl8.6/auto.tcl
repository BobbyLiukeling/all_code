...
proc tcl_findLibrary {basename version patch initScript enVarName varName} {
	...
	# /static/lib/foo1.0		(From bin directory in install hierarchy)
	# /static//static/lib/foo1.0	(From bin/arch directory in install hierarchy)
	# /static/library		(From unix directory in build hierarchy)
	#
	# Remaining locations are out of date (when relevant, they ought to be
	# covered by the $::auto_path seach above) and disabled.
	#
	# /static//static/library		(From unix/arch directory in build hierarchy)
	# /static//static/foo1.0.1/library
	#		(From unix directory in parallel build hierarchy)
	# /static//static//static/foo1.0.1/library
